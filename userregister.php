    ...
    >
      ...
      >
        ...
        <h2 class="text-black font-bold text-lg md:text-xl mt-4 text-center">
          Discover Rajpipla's Essence
        </h2>
        <p class="text-black text-sm text-center mt-2">
          Join a vibrant community and discover India's iconic landmarks, rich
          culture, and seamless travel experiences.
        </p>
      ...
      <div class="w-full md:w-3/5 relative p-6 md:p-10 scroll-container">
        ...
        <br>
        <a href="<?php echo $google_login_url; ?>" class="w-full mt-4 bg-red-500 text-white py-2 rounded-lg text-sm md:text-base text-center block">
