  ...
  <body class="bg-gray-50 font-sans text-gray-800 mt-8">
    <div class="content-wrapper p-6">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
        <div
          class="bg-pink-100 rounded-xl p-6 shadow-md transition duration-300 hover:scale-105"
        >
          <div class="flex items-center justify-between mb-3">
            <span
              class="text-sm bg-pink-50 text-pink-600 px-3 py-1 rounded-full font-semibold"
              >● Culture & Literature</span
            >
            <i class="fa-solid fa-synagogue text-pink-600 text-2xl"></i>
          </div>
          <h3 class="text-lg font-bold mb-2">Rajpipla Book Museum</h3>
          <p class="text-sm text-gray-700 mb-3">
            Explore the rich literary heritage of Rajpipla through preserved
            royal manuscripts and rare books that reflect the kingdom's cultural
            and intellectual legacy.
          </p>
          <p class="text-sm text-gray-800 mb-2">👥 50,000+ visitors inspired</p>
          <a href="#" class="text-pink-700 font-semibold hover:underline"
            >Learn more →</a
          >
        </div>

        <div
          class="bg-blue-100 rounded-xl p-6 shadow-md transition duration-300 hover:scale-105"
        >
          <div class="flex items-center justify-between mb-3">
            <span
              class="text-sm bg-blue-50 text-blue-600 px-3 py-1 rounded-full font-semibold"
              >● Wildlife</span
            >
          ...
          <p class="text-sm text-gray-700 mb-3">
            Experience the wild beauty of Rajpipla through thrilling jungle
        ...
        <div
          class="bg-purple-100 rounded-xl p-6 shadow-md transition duration-300 hover:scale-105"
        >
          <div class="flex items-center justify-between mb-3">
            <span
              class="text-sm bg-purple-50 text-purple-600 px-3 py-1 rounded-full font-semibold"
              >● Book Festivals</span
      ...
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-1 py-1"
      >
        <div
          class="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition"
        >
          <div
            class="flex items-center justify-center w-16 h-16 rounded-full bg-yellow-100 mb-4"
          >
        ...
        >
          <div
            class="flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 mb-4"
          >
        ...
        >
          <div
            class="flex items-center justify-center w-16 h-16 rounded-full bg-purple-100 mb-4"
          >
