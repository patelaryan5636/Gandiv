    ...
    <div class="cards-container">
      ...
      <div class="card">
          ...
          >
            <div class="flex flex-col md:flex-row items-center gap-4">
              ...
              <div class="text-center md:text-left">
                ...
                <p
                  class="text-white/90 text-sm flex items-center justify-center md:justify-start gap-2"
                >
                  <i class="fas fa-compass text-sm"></i>
                  Professional Trip Planner
                </p>
                <div
                  class="flex items-center justify-center md:justify-start mt-1"
                >
            ...
            <div class="flex flex-col items-center md:items-end gap-1 text-sm">
              <span
                class="badge px-3 py-1 rounded-full text-white font-medium flex items-center gap-1"
              >
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 p-3 bg-white">
          <div
            class="stat-card bg-red-300/60 p-2 rounded-lg shadow-md text-center"
          >
          ...
          <div
            class="stat-card bg-blue-300/60 p-2 rounded-lg shadow-md text-center"
          >
          ...
          <div
            class="stat-card bg-teal-300/60 p-2 rounded-lg shadow-md text-center"
          >
          ...
          <div
            class="stat-card bg-purple-300/60 p-2 rounded-lg shadow-md text-center"
          >
        ...
        <div class="p-3">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="bg-gray-50 p-3 rounded-lg shadow-md">
              <h3
                class="text-base font-semibold text-gray-800 mb-2 flex items-center gap-2"
              >
                <i class="fas fa-certificate text-[#94cfcf] text-sm"></i
                >Expertise
              </h3>
            ...
            <div class="bg-gray-50 p-3 rounded-lg shadow-md">
              <h3
                class="text-base font-semibold text-gray-800 mb-2 flex items-center gap-2"
              >
                <i class="fas fa-address-card text-[#94cfcf] text-sm"></i
                >Contact
              </h3>
